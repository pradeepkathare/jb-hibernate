...
import learning.hibernate.jb_hibernate.dto.User_Collections_Example;
 ...
 */
public class C_10_DriverApp {

	public static void main(String[] args) {
		
		//Step to create user object
	User_Collections_Example user = new User_Collections_Example();
